...
const exclaim3 = string => string.toUpperCase() + '!!!'
...
// let nameGreeting = nameCheck('Lane')
...
//   return 'so trendy'}
//   else 
//   return 'you need to evaluate your favority color choice'
// }
...
// const bestMovie = myMovie => `${myMovie} is the best movie ever`
...
// function whaterver (str) {
// console.log(str.toUpperCase())}

// whaterver(sampleString)
...
//   let email1 = String(email)
// let email2 = email1.trim()
// if(email.includes('@')){
//   return 'email verified'
// }else return 'must provide a valid email'
// }

// console.log(emailCheck('lane@gmail.com'))
...
let bathtubScope = ['rubberduck', 'duck', 'sailor duck']
